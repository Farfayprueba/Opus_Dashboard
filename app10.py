...
@app.callback(
    Output('contador-mini-honduras', 'children'),
...
@app.callback(
    Output('button-agregar-mini-honduras', 'disabled'),  # Habilitar/deshabilitar el botón de agregar
    [Input('input-cliente-mini-honduras', 'value'),
     Input('input-likes-mini-honduras', 'value'),
     Input('input-comentarios-mini-honduras', 'value'),
     Input('input-compartidos-mini-honduras', 'value'),
     Input('input-ubicacion-mini-honduras','value')]
)
...
@app.callback(
    Output('clear-button-mini-honduras', 'disabled'),  # Disable the delete button if no row is selected
    [Input('data-table', 'selected_rows')]
)
def update_button_disabled2(selected_rows):
    return len(selected_rows) == 0

@app.callback(Output('data-table2-mini-honduras', 'data'),
              Input('interval-component', 'n_intervals'))
def update_data_table2(n_intervals):
    ...
    return updated_data
@app.callback(
    Output('input-cliente-mini-honduras', 'value'),  # Limpiar el campo de entrada
    Output('input-likes-mini-honduras', 'value'),  # Limpiar la selección de likes
    Output('input-comentarios-mini-honduras', 'value'),  # Limpiar la selección de comentarios
    Output('input-compartidos-mini-honduras', 'value'),
    Output('input-ubicacion-mini-honduras', 'value'),  # Limpiar la selección de compartidos
    [Input('button-agregar-mini-honduras', 'n_clicks'),
     Input('clear-button-mini-honduras', 'n_clicks')],  # Include clear-button-mini-honduras as input trigger
...
@app.callback(
    Output('countdown-mini-honduras', 'children'),
    Output('message-mini-honduras', 'children'),
    Input('interval', 'n_intervals'),
    State('countdown-mini-honduras', 'children')
)
