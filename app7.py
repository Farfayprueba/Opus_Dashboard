...
@app.callback(
    Output('contador-mini-hercules', 'children'),
...
@app.callback(
    Output('button-agregar-mini-hercules', 'disabled'),  # Habilitar/deshabilitar el botón de agregar
    [Input('input-cliente-mini-hercules', 'value'),
     Input('input-likes-mini-hercules', 'value'),
     Input('input-comentarios-mini-hercules', 'value'),
     Input('input-compartidos-mini-hercules', 'value'),
     Input('input-ubicacion-mini-hercules','value')]
)
...
@app.callback(
    Output('clear-button-mini-hercules', 'disabled'),  # Disable the delete button if no row is selected
    [Input('data-table', 'selected_rows')]
)
def update_button_disabled2(selected_rows):
    return len(selected_rows) == 0

@app.callback(Output('data-table2-mini-hercules', 'data'),
              Input('interval-component', 'n_intervals'))
def update_data_table2(n_intervals):
    ...
    return updated_data
@app.callback(
    Output('input-cliente-mini-hercules', 'value'),  # Limpiar el campo de entrada
    Output('input-likes-mini-hercules', 'value'),  # Limpiar la selección de likes
    Output('input-comentarios-mini-hercules', 'value'),  # Limpiar la selección de comentarios
    Output('input-compartidos-mini-hercules', 'value'),
    Output('input-ubicacion-mini-hercules', 'value'),  # Limpiar la selección de compartidos
    [Input('button-agregar-mini-hercules', 'n_clicks'),
     Input('clear-button-mini-hercules', 'n_clicks')],  # Include clear-button-mini-hercules as input trigger
...
@app.callback(
    Output('countdown-mini-hercules', 'children'),
    Output('message-mini-hercules', 'children'),
    Input('interval', 'n_intervals'),
    State('countdown-mini-hercules', 'children')
)
