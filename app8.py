...
@app.callback(
    Output('contador-mini-cancun', 'children'),
...
@app.callback(
    Output('button-agregar-mini-cancun', 'disabled'),  # Habilitar/deshabilitar el botón de agregar
    [Input('input-cliente-mini-cancun', 'value'),
     Input('input-likes-mini-cancun', 'value'),
     Input('input-comentarios-mini-cancun', 'value'),
     Input('input-compartidos-mini-cancun', 'value'),
     Input('input-ubicacion-mini-cancun','value')]
)
...
@app.callback(
    Output('clear-button-mini-cancun', 'disabled'),  # Disable the delete button if no row is selected
    [Input('data-table', 'selected_rows')]
)
def update_button_disabled2(selected_rows):
    return len(selected_rows) == 0

@app.callback(Output('data-table2-mini-cancun', 'data'),
              Input('interval-component', 'n_intervals'))
def update_data_table2(n_intervals):
    ...
    return updated_data
@app.callback(
    Output('input-cliente-mini-cancun', 'value'),  # Limpiar el campo de entrada
    Output('input-likes-mini-cancun', 'value'),  # Limpiar la selección de likes
    Output('input-comentarios-mini-cancun', 'value'),  # Limpiar la selección de comentarios
    Output('input-compartidos-mini-cancun', 'value'),
    Output('input-ubicacion-mini-cancun', 'value'),  # Limpiar la selección de compartidos
    [Input('button-agregar-mini-cancun', 'n_clicks'),
     Input('clear-button-mini-cancun', 'n_clicks')],  # Include clear-button-mini-cancun as input trigger
...
@app.callback(
    Output('countdown-mini-cancun', 'children'),
    Output('message-mini-cancun', 'children'),
    Input('interval', 'n_intervals'),
    State('countdown-mini-cancun', 'children')
)
