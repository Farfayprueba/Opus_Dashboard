...
@app.callback(
    Output('contador-mini-masarik', 'children'),
...
@app.callback(
    Output('button-agregar-mini-masarik', 'disabled'),  # Habilitar/deshabilitar el botón de agregar
    [Input('input-cliente-mini-masarik', 'value'),
     Input('input-likes-mini-masarik', 'value'),
     Input('input-comentarios-mini-masarik', 'value'),
     Input('input-compartidos-mini-masarik', 'value'),
     Input('input-ubicacion-mini-masarik','value')]
)
...
@app.callback(
    Output('clear-button-mini-masarik', 'disabled'),  # Disable the delete button if no row is selected
    [Input('data-table', 'selected_rows')]
)
def update_button_disabled2(selected_rows):
    return len(selected_rows) == 0

@app.callback(Output('data-table2-mini-masarik', 'data'),
              Input('interval-component', 'n_intervals'))
def update_data_table2(n_intervals):
    ...
    return updated_data
@app.callback(
    Output('input-cliente-mini-masarik', 'value'),  # Limpiar el campo de entrada
    Output('input-likes-mini-masarik', 'value'),  # Limpiar la selección de likes
    Output('input-comentarios-mini-masarik', 'value'),  # Limpiar la selección de comentarios
    Output('input-compartidos-mini-masarik', 'value'),
    Output('input-ubicacion-mini-masarik', 'value'),  # Limpiar la selección de compartidos
    [Input('button-agregar-mini-masarik', 'n_clicks'),
     Input('clear-button-mini-masarik', 'n_clicks')],  # Include clear-button-mini-masarik as input trigger
...
@app.callback(
    Output('countdown-mini-masarik', 'children'),
    Output('message-mini-masarik', 'children'),
    Input('interval', 'n_intervals'),
    State('countdown-mini-masarik', 'children')
)
